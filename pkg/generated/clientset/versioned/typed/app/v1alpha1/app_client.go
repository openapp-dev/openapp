...
// AppV1alpha1Client is used to interact with features provided by the app.openapp.dev group.
type AppV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppV1alpha1Client) AppInstances(namespace string) AppInstanceInterface {
	return newAppInstances(c, namespace)
}

func (c *AppV1alpha1Client) AppTemplates() AppTemplateInterface {
