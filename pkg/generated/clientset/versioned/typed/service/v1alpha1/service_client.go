...
import (
	...
	"github.com/openapp-dev/openapp/pkg/generated/clientset/versioned/scheme"
)

type ServiceV1alpha1Interface interface {
	RESTClient() rest.Interface
	PublicServiceInstancesGetter
	PublicServiceTemplatesGetter
}

// ServiceV1alpha1Client is used to interact with features provided by the service.openapp.dev group.
type ServiceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServiceV1alpha1Client) PublicServiceInstances(namespace string) PublicServiceInstanceInterface {
	return newPublicServiceInstances(c, namespace)
}

func (c *ServiceV1alpha1Client) PublicServiceTemplates() PublicServiceTemplateInterface {
	return newPublicServiceTemplates(c)
}
